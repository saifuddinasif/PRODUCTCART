...
const addToCart = (id, price) => {
   count = count + 1;
   /* ekane upore j parameter paise ta update price a patai nai.  updatePrice('price', value) */
   updatePrice('price', price);

   updateTaxAndCharge();
   /* button a click korle total ta  dekai toh na karon updatetotal ta call kora hoi nai  */
   updateTotal()
